...
The default provides a view of volume movements - for example we can see 9 cases moved from the start to "Start Application", 19 moved to "Process Documents" and so on. 
