...
In buparR, "traces" show the different activity sequences that occur. It may be of interest to view both the most common and least common sequences. Here we will narrow down again to just that Settlement activity to see how the statuses move in different sequences within there:
